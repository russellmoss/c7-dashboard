...
export async function GET(
  ...
  try {
    ...
    const competition = await archiveManagementService.getCompetitionDetails(id);
    ...
    console.error(`[API] Error getting competition details for ${params.id}:`, error);
    return NextResponse.json(
...
export async function POST(
  ...
  try {
    ...
    console.log(`[API] POST /api/archive/competitions/${id} - Action: ${action}`);
    ...
    console.error(`[API] Error archiving/restoring competition ${params.id}:`, error);
    return NextResponse.json(
