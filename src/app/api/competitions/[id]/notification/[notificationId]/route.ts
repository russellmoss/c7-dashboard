...
export async function DELETE(
  ...
  try {
    ...
    console.log(
      `[API] DELETE /api/competitions/${id}/notification/${notificationId}`,
    );
    ...
    console.log(
      `[API] ✅ Removed notification: ${notificationId} from competition: ${competition.name}`,
    );
    ...
    console.error(
      `[API] Error removing notification from competition ${params.id}:`,
      error,
    );
    return NextResponse.json(
