...
export async function POST(
  ...
  try {
    ...
    if (result.success && result.sentCount > 0) {
      console.log(`[API] ✅ Welcome SMS sent successfully to ${result.sentCount} subscribers`);
    ...
    console.error(`[API] Error sending welcome SMS for competition ${params.id}:`, error);
    return NextResponse.json(
