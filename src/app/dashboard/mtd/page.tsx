  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <KPICard
          title="Total Revenue"
          value={`$${yoy?.revenue?.current?.toLocaleString()}`}
          change={yoy?.revenue?.change}
          icon={<TrendingUp />}
        />
        <KPICard
          title="Wine Conversion"
          value={`${yoy?.wineConversionRate?.current}%`}
        ...
        <KPICard
          ...
          value={`${yoy?.clubConversionRate?.current}%`}
        ...
        <KPICard
          title="Total Guests"
          value={yoy?.guests?.current?.toLocaleString()}
