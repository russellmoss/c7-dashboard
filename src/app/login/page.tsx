...
const WineGlassLogo = () => (
  <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M24 44V36M24 36C32 36 38 29.732 38 22V6H10V22C10 29.732 16 36 24 36Z" stroke="#a92020" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-red-50 to-pink-50">
      <div className="bg-white shadow-lg rounded-lg p-8 w-full max-w-md flex flex-col items-center">
        <WineGlassLogo />
        <h1 className="text-2xl font-bold text-[#a92020] mt-4 mb-2">Milea KPI Dashboard</h1>
        {showReset ? (
          <form className="w-full mt-4" onSubmit={handleReset}>
            ...
            />
            {resetSent ? (
              <div className="text-green-600 mb-4">Password reset email sent!</div>
            ) : null}
