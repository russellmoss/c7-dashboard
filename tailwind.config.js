...
const config = {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        'wine-gradient': 'linear-gradient(135deg, #cc3333 0%, #a92020 50%, #731f1f 100%)',
        'gold-gradient': 'linear-gradient(135deg, #ffc82a 0%, #eda711 50%, #cc840c 100%)',
        'luxury-gradient': 'linear-gradient(135deg, #cc3333 0%, #eda711 100%)',
        'hero-pattern': "url('data:image/svg+xml,%3Csvg width=\"40\" height=\"40\" viewBox=\"0 0 40 40\" xmlns=\"http://www.w3.org/2000/svg\"%3E%3Cg fill=\"%23ffd951\" fill-opacity=\"0.03\"%3E%3Cpath d=\"M0 40L40 0H20L0 20M40 40V20L20 40\"/%3E%3C/g%3E%3C/svg%3E')",
      },
      boxShadow: {
        'wine': '0 4px 14px 0 rgba(169, 32, 32, 0.15)',
        'gold': '0 4px 14px 0 rgba(237, 167, 17, 0.15)',
        'luxury': '0 10px 40px rgba(169, 32, 32, 0.2), 0 4px 10px rgba(237, 167, 17, 0.1)',
